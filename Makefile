...
INCLUDE =  -I./$(CLASS_DIR) -I./lib/wxwidget/include/wx-3.1
...
wx:
	...
	g++ -g0 -O3 -s --std=c++17 -static-libgcc $(SOURCE) $(WXLIB) $(RUBYLIB) $(INCLUDE) $(LIB) 
